...
int readDataBase(std::string databasePath)
{
    ...
    char* charDatabasePath = new char[x + 1];
...
int selectRecords(std::string databasePath, std::string tableName, std::string chooseRecord)
{
    ...
    char* charChooseRecord = new char[y + 1];
