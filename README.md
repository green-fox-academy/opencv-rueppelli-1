...
## INSTALLATION AND SETUP
 ...
 - Install Sqlite3, gtest and Tesseract with the following command with VCPKG: 'vcpkg install sqlite3:x64-windows', 'vcpkg intall tesseract:x64-windows' and 'vcpkg install gtest:x64-windows'
